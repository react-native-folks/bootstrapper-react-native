...
module.exports = function nextSteps() {
  ...
  if (this.features.hasFirebase) {
    ...
    console.log('  google services files was autogenerated but you still need to replace him with the corresponding application of https://console.firebase.google.com for each environment'.cyan)
  }
