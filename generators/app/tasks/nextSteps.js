...
module.exports = function nextSteps() {
  ...
  console.log('\n\n');
  console.log('● FASTLANE - fastline files was added to the project on android and iOS folders'.cyan);
  console.log('  to start tu use it you need to replace some values on fastlane env files'.cyan);
  console.log('\n');
  console.log('● CONFIG - react native config was added to the project'.cyan);
  console.log('  Probably you should add you API_URL and other env variables on root .env files'.cyan);
  console.log('\n');
  // Firebase
  if (this.features.hasFirebase) {
    console.log('● FIREBASE - Firebase features were added to the project.'.cyan);
    console.log('  google services files was autogenerated but you still need to replace him with the'.cyan)
    console.log('  corresponding application of https://console.firebase.google.com for each environment'.cyan)
    console.log('\n');
  }
  if (this.features.pushnotifications) {
    // Push Notifications SetUp
    console.log('● PUSH NOTIFICATIONS - The push notification config has been added to the project but'.cyan);
  ...
  if (this.features.loginandsignup) {
    ...
    console.log('● LOGIN - A basic login feature has been added. The probably next steps there are:'.cyan);
